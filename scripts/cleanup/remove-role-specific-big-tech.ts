...
/**
 * Remove role-specific content from Big Tech company modules
 * Issue #279: Big Tech batch
 */
...
function main() {
  console.log('Removing role-specific content from Big Tech company modules...\n');
