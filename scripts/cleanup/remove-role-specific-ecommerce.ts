...
/**
 * Remove role-specific content from E-commerce/Retail company modules
 * Issue #283: E-commerce/Retail batch
 */
...
function main() {
  console.log('Removing role-specific content from E-commerce/Retail company modules...\n');
