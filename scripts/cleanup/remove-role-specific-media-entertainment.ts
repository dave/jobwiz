...
/**
 * Remove role-specific content from Media/Entertainment company modules
 * Issue #286: Media/Entertainment batch
 */
...
function main() {
  console.log('Removing role-specific content from Media/Entertainment company modules...\n');
