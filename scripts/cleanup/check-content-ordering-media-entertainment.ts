/**
 * Check content ordering in Media/Entertainment company-role modules
 *
...
const MEDIA_ENTERTAINMENT_COMPANIES = [
  'disney', 'wbd', 'spotify', 'tiktok', 'snap',
  'pinterest', 'reddit', 'linkedin', 'x', 'ea',
  'activision-blizzard', 'roblox'
];
...
function main() {
  ...
  console.log('Media/Entertainment Company-Role Module Content Ordering Check');
  console.log('='.repeat(60));
  console.log();
