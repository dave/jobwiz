/**
 * Check content ordering in E-commerce/Retail company-role modules
 *
...
const ECOMMERCE_COMPANIES = [
  'walmart', 'target', 'best-buy', 'chewy', 'costco', 'etsy',
  'home-depot', 'lululemon', 'nike', 'shopify', 'wayfair'
];
...
function checkModule(filePath: string): OrderingIssue[] {
...
function main() {
  ...
  console.log('E-commerce/Retail Company-Role Module Content Ordering Check');
  console.log('='.repeat(60));
  console.log();
